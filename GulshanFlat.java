...
public class GulshanFlat extends JFrame implements ActionListener{
  JButton bk,b2,b3,b4,b5;
  JLabel l,l1,bl1,bl2,bl3,bl4,bl5,ba1,ba2,ba3,ba4,ba5,ba6,ba7,c1,c2,c3,c4,c5,c6,c7,d1,d2,d3,d4,d5,d6,d7,e1,e2,e3,e4,e5,e6,e7,g1,g2,g3,g4;
  String userEmail;
  ...
  public GulshanFlat(String userEmail){ 
    this.userEmail = userEmail;
//IMAGE SECTION   
   ImageIcon img1=new ImageIcon("./images/wallpaper.png");
   ImageIcon img2=new ImageIcon("./images/Group 30.png ");
   ImageIcon img3=new ImageIcon("./images/gulshan1.png ");
   ImageIcon img4=new ImageIcon("./images/gulshan2.png");
   ImageIcon img5=new ImageIcon("./images/gulshan3.png ");
   ImageIcon img7=new ImageIcon("./images/gulshan4.png ");
...
//1ST TOP LEFT CORNER BOX
 ...
 l.add(b2);
  ...
  bl2.add(ba3);
  ba3=new JLabel();
  ba3.setText("Bathroom: 3 baths ");
  ba3.setBounds(210,97,210,30);
  ba3.setFont(font16);
  bl2.add(ba3);
  ba4=new JLabel();
  ba4.setText("Parking Spaces: 1");
  ba4.setBounds(210,125,210,30);
  ba4.setFont(font16);
  bl2.add(ba4);
  ba5=new JLabel();
  ba5.setText("Address: Gulshan 1");
...
//2ND R8 CORNER BOX
 ...
 l.add(b3);
  ...
  bl3.add(c5);
  c6=new JLabel();
  c6.setText("Address: Gulshan 1");
  c6.setBounds(210,153,210,30);
  c6.setFont(font16);
  bl3.add(c6);
  c7=new JLabel();
  c7.setText("Price: BDT 3.4 crore");
...
bl4.add(d5);
d6=new JLabel();
d6.setText("Address: 2");
d6.setBounds(210,153,210,30);
d6.setFont(font16);
bl4.add(d6);
d7=new JLabel();
d7.setText("Price: BDT 3.8 crore");
...
//4TH BOTTOM R8 CORNER BOX
 ...
 l.add(b5);
  ...
  bl5.add(e5);
  e6=new JLabel();
  e6.setText("Address: Gulshan 2");
  e6.setBounds(210,153,210,30);
  e6.setFont(font16);
  bl5.add(e6);
  e7=new JLabel();
  e7.setText("Price: BDT 3.1 crore");
...
//BACK BUTTON 
   ...
   this.setTitle("GULSHAN APARTMENT");
   ...
   public void actionPerformed(ActionEvent ae){
    ...
    if(ae.getSource()==b2||ae.getSource()==b3||ae.getSource()==b4||ae.getSource()== b5){
