...
public class UttaraFlat extends JFrame implements ActionListener{
 ...
 String userEmail;
  ...
  public UttaraFlat(String userEmail){ 
...
//1ST TOP LEFT CORNER BOX
 ...
 l.add(b2);
  ...
  ba1.setBounds(235,8,140,30);
  ba1.setFont(font20);
  bl2.add(ba1);
  ba2=new JLabel();
  ba2.setText("Area: 2200 sqft");
  ba2.setBounds(210,41,140,30);
  ba2.setFont(font16);
  bl2.add(ba2);
  ba3=new JLabel();
  ba3.setText("Bedroom: 4 beds");
  ba3.setBounds(210,69,140,30);
  ba3.setFont(font16);
  bl2.add(ba3);
  ba4=new JLabel();
  ba4.setText("Bathroom: 3 baths");
  ba4.setBounds(210,97,140,30);
  ba4.setFont(font16);
  bl2.add(ba4);
  ba5=new JLabel();
  ba5.setText("Parking Spaces: 1");
  ba5.setBounds(210,125,160,30);
  ba5.setFont(font16);
  bl2.add(ba5);
  ba6=new JLabel();
  ba6.setText("Address: Sector 12");
  ba6.setBounds(210,153,190,30);
  ba6.setFont(font16);
  bl2.add(ba6);
  ba7=new JLabel();
ba7.setText("Price: BDT 2.3 crore");
ba7.setBounds(210,181,190,30);
ba7.setFont(font16);
  bl2.add(ba7);
...
//2ND R8 CORNER BOX
 ...
 l.add(b3);
   bl3=new JLabel(img4);
     ...
     c1.setBounds(235,8,190,30);
     c1.setFont(font20);
     bl3.add(c1);
     c2=new JLabel();
     c2.setText("Area: 1853 sqft");
     c2.setBounds(210,41,190,30);
     c2.setFont(font16);
     bl3.add(c2);
     c3=new JLabel();
     c3.setText("Bedroom: 3 beds");
     c3.setBounds(210,69,190,30);
     c3.setFont(font16);
     bl3.add(c3);
     c4=new JLabel();
     c4.setText("Bathroom: 3 baths");
     c4.setBounds(210,97,190,30);
     c4.setFont(font16);
     bl3.add(c4);
     c5=new JLabel();
     c5.setText("Parking Spaces: 1");
     c5.setBounds(210,125,190,30);
     c5.setFont(font16);
     bl3.add(c5);
     c6=new JLabel();
     c6.setText("Address: Sector 11");
     c6.setBounds(210,153,190,30);
     c6.setFont(font16);
     bl3.add(c6);
     c7=new JLabel();
     c7.setText("Price: BDT 1.6 crore");
     c7.setBounds(210,181,190,30);
     c7.setFont(font16);
     bl3.add(c7);
...
d1.setBounds(235,8,190,30);
d1.setFont(font20);
bl4.add(d1);
d2=new JLabel();
d2.setText("Area:1320 sqft");
d2.setBounds(210,41,190,30);
d2.setFont(font16);
bl4.add(d2);
d3=new JLabel();
d3.setText("Bedroom: 3 beds");
d3.setBounds(210,69,190,30);
d3.setFont(font16);
bl4.add(d3);
d4=new JLabel();
d4.setText("Bathroom: 2 baths");
d4.setBounds(210,97,190,30);
d4.setFont(font16);
bl4.add(d4);
d5=new JLabel();
d5.setText("Parking Spaces: 1");
d5.setBounds(210,125,190,30);
d5.setFont(font16);
bl4.add(d5);
d6=new JLabel();
d6.setText("Address: Sector 3");
d6.setBounds(210,153,190,30);
d6.setFont(font16);
bl4.add(d6);
d7=new JLabel();
d7.setText("Price: BDT 1.25 crore");
d7.setBounds(210,181,190,30);
d7.setFont(font16);
bl4.add(d7);
...
//4TH BOTTOM R8 CORNER BOX
 ...
 l.add(b5);
  ...
  e1.setBounds(235,8,190,30);
  e1.setFont(font20);
  bl5.add(e1);
  e2=new JLabel();
  e2.setText("Area: 850 sqft");
  e2.setBounds(210,41,190,30);
  e2.setFont(font16);
  bl5.add(e2);
  e3=new JLabel();
  e3.setText("Bedroom: 2 beds");
  e3.setBounds(210,69,190,30);
  e3.setFont(font16);
  bl5.add(e3);
  e4=new JLabel();
  e4.setText("Bathroom: 2 baths");
  e4.setBounds(210,97,190,30);
  e4.setFont(font16);
  bl5.add(e4);
  e5=new JLabel();
  e5.setText("Parking Spaces: 0");
  e5.setBounds(210,125,190,30);
  e5.setFont(font16);
  bl5.add(e5);
  e6=new JLabel();
  e6.setText("Address: Sector 7");
  e6.setBounds(210,153,190,30);
  e6.setFont(font16);
  bl5.add(e6);
  e7=new JLabel();
  e7.setText("Price: BDT 95 laks");
  e7.setBounds(210,181,190,30);
  e7.setFont(font16);
  bl5.add(e7);
...
//BACK BUTTON 
   ...
   this.setTitle("UTTARA APARTMENT");
   ...
   public void actionPerformed(ActionEvent ak){
        //for each button[4]
        if(ak.getSource()==b2||ak.getSource()==b3||ak.getSource()==b4||ak.getSource()== b5){
            PaymentMethod f=new PaymentMethod(userEmail);
           this.setVisible(false);
           f.setVisible(true);
         }
        //back button
         else if(ak.getSource()==b1){
